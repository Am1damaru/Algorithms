...
namespace TestProject
{
    ...
    public class TestLinearSearch
    {
        ...
        {
            string stringIndex = intFunctions[functionNumber](intArray, 10, 9);
        ...
        {
            string stringIndex = stringFunctions[functionNumber](stringArray, 10, "text" + 9);
            int index = int.Parse(stringIndex);
            Assert.AreEqual(index, 9);
        }
        ...
        {
            string stringIndex = intFunctions[functionNumber](intArray, 10, 13);
        ...
        {
            string stringIndex = stringFunctions[functionNumber](stringArray, 10, "text" + 37);
            Assert.AreEqual(stringIndex, Algorithms.LinearSearch.NOT_FOUND);
        }
